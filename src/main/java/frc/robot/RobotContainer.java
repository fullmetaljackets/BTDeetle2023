...
private final XboxController driverControler = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("ShifterToggle", new ShifterToggle( m_driverTrain ));

    SmartDashboard.putData(m_driverTrain);
    SmartDashboard.putData("Reset Encoder", new DriveresetEncoder(m_driverTrain));
    SmartDashboard.putData("Drive 18 inches", new DriveToSetpoint_Distance(.5, 18, m_driverTrain));
    SmartDashboard.putData("Drive -18 inches", new DriveToSetpoint_Distance(-.5, 18, m_driverTrain));
    SmartDashboard.putData("Driver Spin to 180", new DriverSpinToSetpoint(180, m_driverTrain));
    SmartDashboard.putData("Driver Spin to 0", new DriverSpinToSetpoint(0, m_driverTrain));

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=SMARTDASHBOARD
    SmartDashboard.putData("AutoScoreAndDrive", new AutoScoreAndDrive( m_driverTrain , m_intake, m_arm));
    ...
    m_chooser.addOption("AutoScoreAndDrive", new AutoScoreAndDrive( m_driverTrain, m_intake, m_arm ));
