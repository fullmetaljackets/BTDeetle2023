...
private final XboxController driverControler = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Cone", new Cone( m_intake ));
    SmartDashboard.putData("Cube", new Cube( m_intake ));
...
final JoystickButton cubePB = new JoystickButton(driverControler, XboxController.Button.kB.value);        
cubePB.onTrue(new Cube( m_intake ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton conePB = new JoystickButton(driverControler, XboxController.Button.kA.value);        
conePB.onTrue(new Cone( m_intake ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
